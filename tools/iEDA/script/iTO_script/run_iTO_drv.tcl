...
# output files
set OUTPUT_DEF          "$RESULT_DIR/iTO_drv_result.def"
set OUTPUT_VERILOG      "$RESULT_DIR/iTO_drv_result.v"
set DESIGN_STAT_TEXT    "$RESULT_DIR/report/drv_stat.rpt"
set DESIGN_STAT_JSON    "$RESULT_DIR/report/drv_stat.json"
set TOOL_METRICS_JSON   "$RESULT_DIR/metric/iTO_drv_metrics.json"
...
##   reset lib
#===========================================================
source $IEDA_TCL_SCRIPT_DIR/DB_script/db_init_lib_drv.tcl
...
#===========================================================
run_to_drv -config $IEDA_CONFIG_DIR/to_default_config_drv.json
...
feature_summary -path $DESIGN_STAT_JSON -step optDrv

feature_tool -path $TOOL_METRICS_JSON -step optDrv
