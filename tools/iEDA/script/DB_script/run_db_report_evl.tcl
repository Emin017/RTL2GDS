...
##   read def
#===========================================================
def_init -path $RESULT_DIR/asic_top_1220.def

report_wirelength -path  "$RESULT_DIR/report/wirelength.rpt"
report_congestion -path "$RESULT_DIR/report/congestion.rpt"
